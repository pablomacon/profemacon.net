...
El único gate que queda es **B2.5 — recorrido de humo remoto** (`npm run beta:smoke -- https://<host-beta>`), y después el cierre de A1. **A1 todavía no está completo** y sigue prohibido importar cuentas reales.
