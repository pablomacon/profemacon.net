...
export function TeacherGroupPage({ id, onBack, onActivities, onResults }: { id: number; onBack: () => void; onActivities: () => void; onResults: () => void }) {
