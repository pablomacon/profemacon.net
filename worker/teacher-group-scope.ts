...
export class TeacherGroupScopeError extends Error {
  constructor(public readonly status: 403 | 404, public readonly code: "TEACHER_ROLE_REQUIRED" | "TEACHER_GROUP_REQUIRED" | "GROUP_NOT_FOUND", message: string) { super(message); }
}
